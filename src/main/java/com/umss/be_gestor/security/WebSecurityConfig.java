    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers(antMatcher("/usuario/me")).permitAll()
                        .requestMatchers(antMatcher("/usuario/full")).permitAll()
                        .requestMatchers(antMatcher("/usuario/create")).permitAll()
                        .requestMatchers(antMatcher("/usuario/check-email")).permitAll()
